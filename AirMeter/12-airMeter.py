...
def main():
    ...
    LedGruen = 400  # variable green
    LedGelb = 450  # variable yellow
    LedRot = 500  # variable red
    ...
    if Head == "":
        with open(air_file_name, "w") as Header:
            ...
            if Ini_split[8] == "SGP30":
                if Ini_split[9] == "SGP30":
                    Header.write(";CO2-SGP30")
            if Ini_split[12] == "PASCO2":
    ...
    for y in range(0, 4):
        ...
        # print(ccs811.eco2)
        # if(ccs811.eco2 >= LedRot):                #output the value to LEDs
        # print("rot")
